 ...
 *       --pidfile[=FILE]        create pidfile (default: /var/run/openvswitch/vland.pid)
 ...
 *                                (default: /var/log/openvswitch/vland.log)
 ...
 *      VLAN:admin
 *
 *  The following columns are WRITTEN by vland:
 *
 *      VLAN:hw_vlan_config
 *      VLAN:oper_state
 ...
 * Linux Files:
 *
 *  The following files are written by vland
 *
 *      /var/run/openvswitch/vland.pid: Process ID for vland
 *      /var/run/openvswitch/vland.<pid>.ctl: Control file for ovs-appctl
 *
 * @{
 *
 * @file
...
/**************************************************************************//**
 * @details This function is called by the vland main loop for processing
...
/**************************************************************************//**
 * @details This function is called by the vland main loop to wait for
 * any OVSDB IDL processing.
 *****************************************************************************/
extern void vland_wait(void);

/**************************************************************************//**
 * @details This function is called during vland start up to initialize
...
/**************************************************************************//**
 * @details This function is called during vland shutdown to free
 * any data structures & disconnect from the OVSDB IDL interface.
 *****************************************************************************/
extern void vland_ovsdb_exit(void);

/**************************************************************************//**
 * @details This function is called when user invokes ovs-appctl "vland/dump"
 * command.  Prints all vland debug dump information to the console.
 *
